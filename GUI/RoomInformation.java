...
public class RoomInformation extends JFrame {
	...
	public RoomInformation() {
		...
		textField_3.setFont(new Font("HY寃ш퀬�뵓", Font.PLAIN, 12));
		...
		textField_12.setFont(new Font("HY寃ш퀬�뵓", Font.PLAIN, 12));
		...
		textField_13.setFont(new Font("HY寃ш퀬�뵓", Font.PLAIN, 12));
