...
public class MENU_ADMIN extends JFrame {
	...
	public MENU_ADMIN(String sql) { //기존의 SQL의 결과를 가져오는 방식과 달리 결과값을 합친 문장을 잘라서 넣는 방식을 사용하였다.
		...
		txtF.setFont(new Font("HY寃ш퀬�뵓", Font.PLAIN, 16));
		txtF.setText("교직원정보");
		...
		textField.setFont(new Font("HY寃ш퀬�뵓", Font.PLAIN, 12));
		...
		txtF_1.setText(tokens.nextToken());
		...
		textField_3.setText("생활관관리"); //생활관직원에 대한 테이블은 크게 필요 없다고 가정하고 진행하였기 때문에 이부분은 그냥 두겠습니다.
		...
		textField_6.setText(tokens.nextToken());
		...
		textField_7.setText("재직"); //생활관직원에 대한 테이블은 크게 필요 없다고 가정하고 진행하였기 때문에 이부분은 그냥 두겠습니다.
		...
		textField_8.setText(tokens.nextToken());
		...
		textField_2.setFont(new Font("HY寃ш퀬�뵓", Font.PLAIN, 16));
		...
		JButton button = new JButton("신청자조회");
		...
		button_1.setBounds(12, 355, 100, 30);
		getContentPane().add(button_1);
		
		JButton button_2 = new JButton("학생호실정보");
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//new AdminStudentAllocate();
			}
		});
		button_2.setBounds(144, 355, 100, 30);
		getContentPane().add(button_2);
		
		JButton button_3 = new JButton("관생선발");
		...
		JButton button_4 = new JButton("입금확인조회");
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		button_4.setBounds(284, 298, 100, 30);
